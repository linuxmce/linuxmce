...
DEVICEDATA_DISTRO_Ubuntu_Bionic_CONST=24
DEVICEDATA_DISTRO_Raspbian_Buster_CONST=25
DEVICEDATA_DISTRO_Ubuntu_Noble_CONST=27
...
case "$TARGET_RELEASE" in
	...
	xenial)
		...
		TARGET_LTS_HES=""	;;
	bionic)
		TARGET_DISTRO_ID=$DEVICEDATA_DISTRO_Ubuntu_Bionic_CONST
		TARGET_REPO_DISTRO_SRC=24
		TARGET_REPO_LMCE_SRC=25
		TARGET_LTS_HES=""	;;
	noble)
		TARGET_DISTRO_ID=$DEVICEDATA_DISTRO_Ubuntu_Noble_CONST
		TARGET_REPO_DISTRO_SRC=24
		TARGET_REPO_LMCE_SRC=25
		TARGET_LTS_HES=""	;;
	wheezy)
	...
	jessie)
		...
		TARGET_REPO_LMCE_SRC=23	;;
	buster)
		TARGET_DISTRO_ID=$DEVICEDATA_DISTRO_Raspbian_Buster_CONST
		TARGET_REPO_DISTRO_SRC=22
		TARGET_REPO_LMCE_SRC=23	;;
esac
